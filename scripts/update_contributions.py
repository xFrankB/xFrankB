...
def build_readme(years: list[int], calendars: dict[int, dict], language: str) -> str:
    ...
    if spanish:
        hero = picture("hero-es.svg?v=14", "hero-es-light.svg?v=14", "xFrankB — Francisco Baylón", width="100%")
        ...
        hero = picture("hero.svg?v=14", "hero-light.svg?v=14", "xFrankB — Francisco Baylón", width="100%")
