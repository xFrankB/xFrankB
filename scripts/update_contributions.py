...
def build_readme(years: list[int], calendars: dict[int, dict], language: str) -> str:
    ...
    if spanish:
        hero = animated_picture("hero-es.webp?v=21", "hero-es-light.webp?v=21", "hero-es.gif?v=18", "hero-es-light.gif?v=18", "xFrankB — Francisco Baylón", width="100%")
        ...
        hero = animated_picture("hero.webp?v=21", "hero-light.webp?v=21", "hero.gif?v=18", "hero-light.gif?v=18", "xFrankB — Francisco Baylón", width="100%")
